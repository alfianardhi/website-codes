        ...
        <div className='row'>
          <div className='col-lg-6 col-12'>
            <div className='contact-form'>
              <h2 className='mb-4 mobile-mt-2'>Contact</h2>
              ...
              <ul className='social-links'>
                ...
                <li>
                  <a href='http://www.youtube.com' className='uil uil-youtube' data-toggle='tooltip' data-placement='left' title='Youtube'>
                    <svg
                      xmlns='http://www.w3.org/2000/svg'
                ...
                <li>
                  <a href='http://www.gmail.com' className='uil uil-youtube' data-toggle='tooltip' data-placement='left' title='Gmail'>
                    <svg
                      xmlns='http://www.w3.org/2000/svg'
              ...
              <a href='mailto:ardhi.alfian@gmail.com' className='btn custom-btn custom-btn-bg submit-btn'>
                Get In Touch
              </a>
            </div>
          </div>
